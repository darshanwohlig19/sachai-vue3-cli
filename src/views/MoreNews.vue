          ...
          >
            ...
            >
              ...
              <div
                ...
                class="text-[12px] lg:text-[16px] fontCustom leading-1 bold mr-1 mt-1 cursor-pointer"
              >
                {{ item.headline || "No Headline" }}
              </div>
              <div
                @click="navigateToMoreNews(item._id)"
                class="text-[10px] lg:text-[12px] text-[#878787] font-lato multiline-truncate leading-1 mr-1 mt-1 mb-1 cursor-pointer"
              >
