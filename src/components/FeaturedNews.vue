<template>
  ...
  >
    ...
    <div class="w-full md:w-[50%] flex flex-col justify-between">
      <div
    ...
    <div class="w-full md:w-[100%] flex flex-col justify-between mt-4 md:mt-0">
      <div v-for="item in blogs2" :key="item.id" class="flex flex-row gap-2">
        <div class="w-[5%] mt-2">
